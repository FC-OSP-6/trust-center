...
// if you put this inside a function, you'd get a fresh empty cache on every call which is wrong
...
export type { ListArgs } from './keys'; // also re-exported the args type for convenience
